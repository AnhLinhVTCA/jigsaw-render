...
var SpriteBatch = new Class({
  ...
  _createVertexAttributes: function () {
    ...
    return [
      ...
      new Mesh.Attrib('a_maskCoord0', 2),
    ];
  },
  ...
  draw: function (
    ...
    //muv
    this.vertices[this.idx++] = mu1;
    this.vertices[this.idx++] = mv1;
...
SpriteBatch.DEFAULT_FRAG_SHADER = [
  ...
  'varying vec2 vMaskCoord0;',
  'varying vec4 vColor;',
  'uniform sampler2D u_texture0;',
  'uniform sampler2D u_mask;',

  'void main(void) {',
  '   if (texture2D(u_mask, vMaskCoord0).a <= 0.0) discard;',
